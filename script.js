...
document.getElementById("demo").onclick = function() {myFunction()};
	...
	function myFunction() {
		document.getElementById("demo").innerHTML = "The Milky way is always the best way,";
	}
...
document.getElementById("demo6").onclick = function() {myFunction6()};
	...
	function myFunction6() {
		document.getElementById("demo6").innerHTML = "Just a small cup in a ";
	}
	
document.getElementById("demo7").onclick = function() {myFunction7()};

	function myFunction7() {
		document.getElementById("demo7").innerHTML = "One of the best cakes";
	}
